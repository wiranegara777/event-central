...
<style>
body { background-image: url("images/bing_chicago_final-51-w1200h800.jpg");
min-height: 300px;
...
<div class="w3-content" style="max-width:1400px">
  ...
  <div class="w3-responsive w3-bar w3-card-8 w3-text-red" style="background: rgba(0,0,0,0);">
      <span class="w3-mobile w3-bar-item" style="font-family:'Damion'; font-size:18px">EventCentral</span>
