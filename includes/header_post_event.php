...
<script language="javascript">alert("You must Log in first :)");</script>
      ...
      <span class="w3-bar-item" style="font-family:'Damion'; font-size:18px">Event Central</span>
        ...
        <?php } ?>
          <?php if($_SESSION['status'] == "nouser") { ?>
            <a href="login/loglog.php"><span class="w3-right w3-hover-text-black  w3-bar-item"><i class="fa fa-address-book-o"></i>Register</span></a>
