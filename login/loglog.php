...
<head>
<title>Log In | Home :: w3layouts</title>
...
<div class="main-content-agile">
	<div class="sub-main-w3">
		<form action="../modules/loginprocess.php" method="post">
			<input placeholder="Username or E-mail" name="emailmhs" class="user" type="text" required=""><br>
			<input  placeholder="Password" name="passmhs" class="pass" type="password" required=""><br>
